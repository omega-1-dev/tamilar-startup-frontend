...
export default function () {
  return (
    <div>
        ...
        >
            <video autoPlay loop muted className="absolute top-0  w-full h-full object-cover  z-[-1] bg-local">
                <source src={herovid} type="video/mp4" />
            </video>
        </div>
        <div className={`flex flex-col h-screen w-full justify-center items-center p-5 lg:p-0`}>
            ...
            <div className={`flex mb-8`}>
                ...
                <div className={`flex items-center`}>
                    ...
                    <span className={`text-white font-bold text-2xl`}>Dharmapuri, Tamil Nadu</span>
                </div>
            </div>
            ...
            <p>
                <div className={`flex items-center`}>
                    ...
                    <span className={`text-white font-bold text-xl`}>Hurry up! Few seats left.</span>
                </div>
            </p>
        </div>
    </div>
