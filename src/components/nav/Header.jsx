...
export default function(props) {
    ...
    return <div className={`flex justify-between w-full p-3 pt-3 transition duration-75 ease-in-out ${scrolled ? 'bg-gray-900' : ''} ${className}`}>
        ...
        <div className={`hidden lg:flex justify-center items-center flex-1 text-center`}>
